...
#Test EDSR in the paper (x4)
python main.py --data_test Demo --scale 4 --n_resblocks 32 --n_feats 256 --res_scale 0.1 --test_only --save_results --pre_train download
#x2
python main.py --data_test Demo --scale 2 --n_resblocks 32 --n_feats 256 --res_scale 0.1 --test_only --save_results --pre_train ../experiment/edsr_x2/model/model_best.pt

# Test DBPN
python main.py --model DBPN --data_test Demo --dir_test /workspace/daehee/datasets/coco/modif/[]  --save coco_DN_X2_DBPN --scale 2 --patch_size 64 --test_only --save_results --pre_train ../experiment/dbpn_x2_DN/model/mode_best.pth
python main.py --model DBPN --data_test Demo --dir_demo /workspace/daehee/datasets/coco/modif/DNx4  --save coco_DN_X4_DBPN --scale 4 --patch_size 128 --test_only --save_results --pre_train ../experiment/dbpn_x4_DN/model/model_best.pt
...
'''
# DBPN
python main.py --model DBPN --scale 2 --patch_size 64 --save DBPN_BD_X2_jpg --save_results --reset --batch_size 20

# MSRN
python main.py --model MSRN --scale 2 --patch_size 128 --save MSRN_BD_X2_jpg --save_results --reset --ext sep-reset
# -
