...
parser = argparse.ArgumentParser(description='PSNR and SSIM')

parser.add_argument('--dir_gt', type=str, help='ground-truth')
parser.add_argument('--dir_gen', type=str, help='SR img')
...
def main(args):
    ...
    folder_GT = args.dir_gt
    folder_Gen = args.dir_gen
